...
def recibo():
    ...
    texto_recibo.insert(END, f'  Coste del Postre: \t\t\t{var_costo_postre.get()}\n')
    texto_recibo.insert(END, f'-' * 54 + '\n')
...
# panel comidas
panel_comidas = LabelFrame(panel_izquierdo, text='Comida', font=('Dosis', 10, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
panel_comidas.pack(side=LEFT)

# panel bebidas
panel_bebidas = LabelFrame(panel_izquierdo, text='Bebida', font=('Dosis', 10, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
panel_bebidas.pack(side=LEFT)

# panel postres
panel_postres = LabelFrame(panel_izquierdo, text='Postres', font=('Dosis', 10, 'bold'),
                           bd=1, relief=FLAT, fg='azure4')
...
# lista de productos
lista_comidas = ['pollo', 'cordero', 'salmon', 'merluza', 'kebab', 'pizza', 'rissoto', 'nuggets']
lista_bebidas = ['agua', 'cerveza', 'fanta', '7up', 'zumo', 'vino', 'cerveza sin', 'aquarius']
lista_postres = ['helado', 'mouse', 'tarta zanahoria', 'tarta 3 leches', 'flan', 'yogurt', 'fruta', 'brownie']
...
texto_total.grid(row=2, column=3, padx=70)
